...
function SpansTableContent() {
  ...
  const handleRowClick = useCallback(
    (row: Row<SpanRow>) => {
      ...
      traceParams.set("spanId", row.original.spanId);
      traceParams.delete("traceId");
      router.push(`/project/${projectId}/traces/${row.original.traceId}?${traceParams.toString()}`);
    },
  ...
  const getRowHref = useCallback(
    (row: Row<SpanRow>) => {
      ...
      return `/project/${projectId}/traces/${row.original.traceId}?${params.toString()}`;
    },
