...
export const githubDarkSyntaxHighlighter = {
  ...
  tag: { color: "#7ee787" },
  boolean: { color: "#49db7e" },
  number: { color: "#79c0ff" },
  constant: { color: "#49db7e" },
  symbol: { color: "#49db7e" },
  ...
  keyword: { color: "#49db7e" },
  function: { color: "#d2a8ff" },
  "class-name": { color: "#d2a8ff" },
  regex: { color: "#a5d6ff" },
  important: { color: "#49db7e", fontWeight: "bold" },
};
...
export const githubDarkStyle: CreateThemeOptions["styles"] = [
  ...
  { tag: [t.keyword, t.typeName, t.typeOperator, t.typeName], color: "#49db7e" },
  { tag: [t.string, t.meta, t.regexp], color: "#a5d6ff" },
  { tag: [t.name, t.quote], color: "#c9d1d9" },
  { tag: [t.heading, t.strong], color: "#d2a8ff", fontWeight: "bold" },
  { tag: [t.emphasis], color: "#d2a8ff", fontStyle: "italic" },
  { tag: [t.deleted], color: "#ffdcd7", backgroundColor: "#ffeef0" },
  { tag: [t.atom, t.bool, t.special(t.variableName)], color: "#49db7e" },
