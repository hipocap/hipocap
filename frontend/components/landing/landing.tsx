...
const sections: Section[] = [
  {
    ...
    With Hipocap, you can start tracing with a single line of code.`,
  ...
  },
  {
    ...
    With Hipocap, you can run custom evals via code, CLI, or CI/CD pipeline.`,
  ...
  },
  {
    ...
    callToAction: "Try out Hipocap Playground",
  },
  {
    id: "labeling",
    title: "Labeling",
            ...
            <div className="flex flex-col w-full relative md:pb-0 rounded">
              ...
              <div className="px-4 md:px-0">
                <h1 className="text-2xl md:text-[2.4rem] font-bold tracking-normal font-title text-white py-16 md:py-32 leading-tight">
                  With Hipocap, teams monitor agents in production, <br />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-16 my-8 md:mb-24 mb-16">
                  ...
                  <FeatureCard
                    title="Powerful SDK"
                    subtitle="With Hipocap best-in-class SDK you can easily trace your agents and write powerful evals."
                    className="hidden md:block"
                  />
                  <FeatureCard
        ...
        <div className="flex flex-col w-full max-w-full xl:max-w-[1200px] md:pt-8 2xl:pt-32">
          <div className="flex items-center justify-center flex-col">
            <div className="p-6 flex flex-col h-full gap-8 max-w-[900px]">
              <p className="text-3xl md:text-[2.4rem] leading-normal text-white text-center font-title font-bold">"Hipocap's evals help us maintain high accuracy while moving fast. We now use them for every LLM based feature we build."</p>
            </div>
            <div>
        ...
        <div className="md:grid md:grid-cols-2 md:gap-16">
          ...
          <div className="flex flex-col order-2 xl:max-w-[600px]">
            <div ref={el => { sectionRefs.current["frameworks"] = el; }} className="flex flex-col md:h-screen justify-center my-8 md:my-0 pt-16 md:pt-0">
              ...
              <InfoCard
                title=""
                description="Simply initialize Hipocap at the top of your project and popular LLM frameworks and SDKs will be automatically traced. Use our SDK to add comprehensive tracing to your agent."
                animationOrder={0}
            ...
            <div ref={el => { sectionRefs.current["observe"] = el; }} className="flex flex-col md:min-h-screen my-8 md:my-0">
              ...
              <div className="px-4 md:px-0">
                <InfoCard
                  ...
                  description="Don't wait until the end of your AI agent run to start debugging. Hipocap shows spans as they happen in real time."
                  animationOrder={1}
                />
                <InfoCard
                  title="Automatic error capture"
                  description="Hipocap automatically captures application level exceptions."
                  animationOrder={1}
                />
                <InfoCard
              ...
              <InfoCard
                ...
                description={
                  <div className="flex flex-col gap-4">
                    <p>Hipocap automatically captures browser window recordings and syncs them with agent traces to help you see what the browser agent sees. Hipocap automatically traces <span className="text-white font-semibold">Browser Use, Stagehand and Playwright</span>.</p>
            ...
            <div ref={el => { sectionRefs.current["query"] = el; }} className="flex flex-col md:min-h-screen my-8 md:my-0">
              ...
              <div className="px-4 md:px-0">
                ...
                <InfoCard
                  ...
                  description="Use the Hipocap SQL API to query traces, evals, datasets, and events data from your own applications."
                  animationOrder={1}
                />
              </div>
            </div>
