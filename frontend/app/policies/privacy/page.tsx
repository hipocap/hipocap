  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      <div>
        ...
        <div>
          <ul>
            <li><span>Use Hipocap. Open-source AI engineering platform offering observability, evaluations, and advanced data management</span>
            </li>
          </ul>
          <ul>
