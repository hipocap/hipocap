  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      <div>
        ...
        <div><span>This Cookie Policy explains how LMNR AI, Inc. (DBA Hipocap) ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," and "<strong>our</strong>") uses cookies and similar technologies to recognize you when you visit our website at </span>
            ...
            <div>
              <table>
                <tbody>
                  ...
                  <tr>
                    <th> Provider:</th>
                    <td><span>LMNR AI, Inc. (DBA Hipocap)</span></td>
                  </tr>
                  <tr>
                    <th>Type: </th>
