...
export default function WelcomeEmail({ }: {}) {
  return (
    <Html lang="en">
      <Preview>Welcome to Hipocap - start tracing, evaluating, and analyzing your LLM app in minutes</Preview>
      <div style={container}>
        <Text style={heading}>Welcome to Hipocap! 👋</Text>
        <Text style={text}>
          I{"'"}m Robert, CEO of Hipocap. Stoked to have you join our community!
        </Text>
        <Text style={text}>
          With Hipocap you can trace, evaluate, label, and analyze your LLM application.
          Hipocap is fully open source, so don{"'"}t forget to
        ...
        <Text style={role}>Co-founder & CEO @ Hipocap</Text>
      </div>
    </Html>
  );
}
