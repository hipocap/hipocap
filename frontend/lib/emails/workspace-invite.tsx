...
export default function WorkspaceInviteEmail({
  ...
  return (
    <Html lang="en">
      <Preview>You{"'"}ve been invited to join {workspaceName} on Hipocap</Preview>
      <div style={container}>
        <Text style={heading}>Join {workspaceName} on Hipocap! 🎉</Text>
        <Text style={text}>
          You{"'"}ve been invited to collaborate on {workspaceName} workspace.
        </Text>
        <Text style={text}>
          With Hipocap you can trace, evaluate, label, and analyze LLM applications together with your team.
        </Text>
        <Text style={text}>
        ...
        <Text style={signature}>The Hipocap Team</Text>
      </div>
    </Html>
  );
}
